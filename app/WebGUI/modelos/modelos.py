...
class VisitaMenor(Visita):
	...
	def get_menor_edad(self):
		return self.__menor_edad

	def set_menor_edad(self, menor_edad):
		self.__menor_edad = menor_edad
...
class Configuracion(metaclass=ABCMeta):
	@abstractmethod
	def modificar(self):
		pass
...
class BicicletaConfig():

	def __init__(self, monto=10000, porcentaje_desc=10, **kwargs):
		super().__init__(**kwargs)
		self.__monto = monto
		self.__porcentaje_desc = porcentaje_desc
	...
	def get_porcentaje_desc(self):
		return self.__porcentaje_desc

	def set_porcentaje_desc(self, porcentaje_desc):
		self.__porcentaje_desc
